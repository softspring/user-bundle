...
class AdministratorsController extends AbstractController
{
    ...
    public function demoteAdmin(string $administrator, Request $request): Response
    {
        ...
        if (($response = $this->dispatchGetResponse(SfsUserEvents::ADMIN_ADMINISTRATORS_DEMOTE_INITIALIZE, new GetResponseUserEvent($administrator, $request))) instanceof Response) {
            return $response;
        }
        ...
        if (($response = $this->dispatchGetResponse(SfsUserEvents::ADMIN_ADMINISTRATORS_DEMOTE_SUCCESS, new GetResponseUserEvent($administrator, $request))) instanceof Response) {
            return $response;
        }
    ...
    public function promoteSuper(string $administrator, Request $request): Response
    {
        ...
        if (($response = $this->dispatchGetResponse(SfsUserEvents::ADMIN_ADMINISTRATORS_PROMOTE_SUPER_INITIALIZE, new GetResponseUserEvent($administrator, $request))) instanceof Response) {
            return $response;
        }
        ...
        if (($response = $this->dispatchGetResponse(SfsUserEvents::ADMIN_ADMINISTRATORS_PROMOTE_SUPER_SUCCESS, new GetResponseUserEvent($administrator, $request))) instanceof Response) {
            return $response;
        }
    ...
    public function demoteSuper(string $administrator, Request $request): Response
    {
        ...
        if (($response = $this->dispatchGetResponse(SfsUserEvents::ADMIN_ADMINISTRATORS_DEMOTE_SUPER_INITIALIZE, new GetResponseUserEvent($administrator, $request))) instanceof Response) {
            return $response;
        }
        ...
        if (($response = $this->dispatchGetResponse(SfsUserEvents::ADMIN_ADMINISTRATORS_DEMOTE_SUPER_SUCCESS, new GetResponseUserEvent($administrator, $request))) instanceof Response) {
            return $response;
        }
